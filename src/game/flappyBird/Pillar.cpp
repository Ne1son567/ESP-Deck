...
void Pillar::updatePillar()
{
    ...
    DisplayManager::renderPartialBitmap(xPos + xSize, yPos - ySize - gap - openingYSize, xPos + xSize, yPos - ySize - gap - openingYSize, speed, ySize, 480, skyBackgroundBitmap);
    ...
    DisplayManager::renderPartialBitmap(xPos - ((openingXSize - xSize) / 2) + openingXSize, yPos - gap - openingYSize , xPos - ((openingXSize - xSize) / 2) + openingXSize ,  yPos - gap - openingYSize, speed, openingYSize, 480, skyBackgroundBitmap);
    ...
    DisplayManager::renderPartialBitmap(xPos + xSize, yPos + gap + openingYSize-1, xPos + xSize, yPos + gap + openingYSize-1, speed, 250 - yPos - gap - openingYSize +1, 480, skyBackgroundBitmap);
    ...
    DisplayManager::renderPartialBitmap(xPos - ((openingXSize - xSize) / 2) + openingXSize, yPos + gap ,xPos - ((openingXSize - xSize) / 2) + openingXSize, yPos + gap , speed, openingYSize, 480, skyBackgroundBitmap);
...
void Pillar::gameOverAnimation()
{
    ...
    DisplayManager::tft.fillRect(xPos - ((openingXSize-xSize)/2) + 1, yPos - gap - openingYSize + 1, openingXSize -2, openingYSize -2, DisplayManager::tft.color565(7, 219, 64));
    DisplayManager::tft.drawRect(xPos - ((openingXSize-xSize)/2), yPos - gap - openingYSize , openingXSize, openingYSize, DisplayManager::tft.color565(0,0,0));
    DisplayManager::renderPartialBitmap(xPos - ((openingXSize-xSize)/2), yPos - gap, xPos - ((openingXSize-xSize)/2) , yPos - gap, openingXSize, 2 , 480, skyBackgroundBitmap);

    if(yPos + gap + openingYSize <= 251)
    {
        DisplayManager::tft.fillRect(xPos - ((openingXSize-xSize)/2)+1, yPos + gap + 1, openingXSize -2, openingYSize - 2, DisplayManager::tft.color565(7, 219, 64));
        DisplayManager::tft.drawRect(xPos - ((openingXSize-xSize)/2), yPos + gap, openingXSize, openingYSize, DisplayManager::tft.color565(0,0,0));
        DisplayManager::renderPartialBitmap(xPos - ((openingXSize-xSize)/2), yPos + gap - 2, xPos - ((openingXSize-xSize)/2) , yPos + gap -2, openingXSize, 2 , 480, skyBackgroundBitmap);
    }
